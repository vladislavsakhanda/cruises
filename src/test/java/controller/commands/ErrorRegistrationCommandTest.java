...
public class ErrorRegistrationCommandTest {
    @Mock
    ...
    @Spy
    private ErrorRegistrationCommand command;
    ...
    @Test
    public void doPostTest() throws ServletException, IOException, IllegalFieldException {
